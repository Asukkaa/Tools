...
public class FileNameToExcelService {
     ...
     * 构建输出文件名称的excel
     */
    public static XSSFWorkbook buildFileNameExcel(List<String> names, ExcelConfigBean excelConfigBean) throws Exception {
        ...
        //构建excel
        buildNoGroupExcel(names, sheet, excelConfigBean);
        return workbook;
    }
